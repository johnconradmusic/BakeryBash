...
public static class Fonts
{
	...
	public static PixelFont SmallGameplayFont;
	public static PixelFont ComicGecko;
	public static void LoadFonts()
	{
		Prepare();
		SmallGameplayFont = Fonts.Load("Montserrat SemiBold");
		ComicGecko = Fonts.Load("Comic Gecko");
		Fonts.Load("Anime Ace 2.0 BB");
	...
	public static void Prepare()
	{
		...
		foreach (string file in Directory.GetFiles(Path.Combine(Engine.ContentDirectory, "Fonts"), "*.fnt", SearchOption.AllDirectories))
		{
