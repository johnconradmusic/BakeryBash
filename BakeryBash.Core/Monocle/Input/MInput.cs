...
namespace Monocle
{
	public static class MInput
	{
		...
		public static MInput.TouchData Touch { get; private set; }

		internal static void Initialize()
		{
			MInput.Keyboard = new MInput.KeyboardData();
			MInput.Mouse = new MInput.MouseData();
			MInput.Touch = new MInput.TouchData();
		...
		public class TouchData
		{
			...
			public void Vibrate(int strength)
			{
				...
				{
					var impact = new UIImpactFeedbackGenerator((UIImpactFeedbackStyle)strength);
					impact.Prepare();
			...
			public bool Tapped;
			public Vector2 Position;
			public Vector2 JustifiedPosition;
			...
			public void Update()
			{
				...
				while (TouchPanel.IsGestureAvailable)
				{
					...
					JustifiedPosition = new Vector2(Position.X / TouchPanel.DisplayWidth, Position.Y / TouchPanel.DisplayHeight);
					ScreenPosition = new Vector2(JustifiedPosition.X * Engine.ViewWidth, JustifiedPosition.Y * Engine.ViewHeight);
				}
